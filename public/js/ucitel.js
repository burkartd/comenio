...
async function vlastniZprava(msg, jmeno)
{
    const div = document.createElement('div');
    ...
    div.innerHTML = `
                    ...
                    <span class="w-8 ml-2" id='vlajka_odpoved'>
...
async function PrelozUaCz(msg)
{
    var vysledek;
    
    await translate(msg, 'es').then((wtf) => {
        console.log(wtf);
        vysledek = wtf;
    });
    ...
    //console.log(res);
    // let res = translate(msg, {from: "ua", to: "cz"});
    //return res;
}
...
function odpovedZprava(msg, jmeno)
{
    ...
    div.classList.add('stin');
    div.innerHTML = `
                    <svg class="w-10 text-green-700 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6"></path></svg>
                    <span class="w-8 ml-2" id='vlajka_odpoved'>
                    <img src="./img/ua.png" id="ua" class="">
                    </span>
                    <span class="ml-4">${jmeno}:</span>
